      ...
      <div className="container" data-aos="fade-up" data-aos-duration="800" data-aos-delay="500">
        <div className="row d-flex">
          <div className="col-lg-6">
            ...
            <div id="st-alert"></div>
            <form action="https://formspree.io/f/xjkokavb" method="POST" className="st-contact-form" id="contact-form">
            ...
            <div className="st-contact-info-wrap">
              <div className="st-single-contact-info">
                ...
                <div className="st-single-info-details">
                  <h4>Email</h4>
                <a href="mailto:nelvinekavaya@gmail.com?subject=Portfolio Contact&body=Hello Nelvine,">nelvinekavaya@gmail.com</a>
                <a href="mailto:mwikalinelvine@gmail.com">mwikalinelvine@gmail.com</a>
              ...
              <div className="st-single-contact-info">
                ...
                <div className="st-single-info-details">
                  <h4>Phone</h4>
                  <span>+254 748 609 410</span>
                  <span>+254 734 416 944</span>
                </div>
              </div>
              <div className="st-single-contact-info">
                <div className="st-icon-wrap">
                ...
                <div className="st-single-info-details">
                  <h4>Address</h4>
                  <span>MAKTABA KUU BUILDING, COMMUNITY, NGONG ROAD, <br />30573-00100 NAIROBI</span>
                </div>
              </div>
